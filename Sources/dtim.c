...
uint32_t DTimGetCount(uint8 u8DTimModule){
	uint32_t count0;
	count0=(uint32_t)MCF_DTIM_DTCN(u8DTimModule);
	MCF_DTIM_DTCN(u8DTimModule)=0x00;
	return count0;
	/*uint32_t count;
	count=(uint32_t)MCF_DTIM_DTCN(u8DTimModule);
//	MCF_DTIM_DTCN(u8DTimModule)=0x00;
	return count;    */
}
