...
//int InitializeUART(UART_CONSOLE_BAUD_RATE){
//	uart_init(0,SYSTEM_CLOCK_KHZ,UART_CONSOLE_BAUD_RATE);
//	return 0; //kUARTNoError
//}
//int WriteUARTN(buffer, count) {
//	uart_putstr(0, (char*)buffer);
//	return 0; //kUARTNoError
//}
...
void uart_putstr(int channel, char* str){
	int i = 0;
	while(str[i]!='\0'){
		uart_putchar(channel, str[i++]);
	}
}
/********************************************************************/
/*
